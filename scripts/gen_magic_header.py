...
DATA_TYPE_FIRMWARE = 1  # 固件数据类型
BL_VERSION_MAJOR = 1    # 主版本号
BL_VERSION_MINOR = 0    # 次版本号
BL_VERSION_PATCH = 0    # 补丁版本号
BL_VERSION_EXTRA = "alpha" # 扩展号
...
def main():
    ...
    header.append((this_crc32).to_bytes(4, byteorder='little'))  # this_crc32
